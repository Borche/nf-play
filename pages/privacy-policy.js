export default function PrivacyPolicyPage() {
  return (
    <>
      <h1>Privacy Policy for NF Play Ltd</h1>

      <p>
        At NF Play, accessible from localhost:3000, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is collected and recorded by NF Play
        and how we use it.
      </p>
      ...
      <p>
        ...
        with regards to the information that they shared and/or collect in NF Play. This policy is not
      ...
      <p>
        NF Play follows a standard procedure of using log files. These files log visitors when they visit
      ...
      <p>
        Like any other website, NF Play uses 'cookies'. These cookies are used to store information including
      ...
      <p>
        You may consult this list to find the Privacy Policy for each of the advertising partners of NF Play.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
        are used in their respective advertisements and links that appear on NF Play, which are sent directly
      ...
      <p>
        Note that NF Play has no access to or control over these cookies that are used by third-party
        advertisers.
      </p>
      ...
      <p>
        NF Play's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      <p>
        NF Play does not knowingly collect any Personal Identifiable Information from children under the age
